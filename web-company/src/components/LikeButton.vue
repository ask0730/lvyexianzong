<template>
    <div class="like-button" @click="toggleLikeThrottled">
...
const fetchLikeInfo = async () => {
    try {
        const [statusRes, countRes] = await Promise.all([getLikeStatus(props.newsId), getLikeCount(props.newsId)])
...
const toggleLikeThrottled = throttle(toggleLike, 800)
